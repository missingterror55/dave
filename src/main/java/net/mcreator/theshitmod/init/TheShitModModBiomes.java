...
import net.mcreator.theshitmod.world.biome.HellBiome;
...
public class TheShitModModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, TheShitModMod.MODID);
			...
			if (dimensionType == dimensionTypeRegistry.getOrThrow(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					parameters.add(new Pair<>(HellBiome.PARAMETER_POINT,
							biomeRegistry.getOrCreateHolderOrThrow(ResourceKey.create(Registry.BIOME_REGISTRY, HELL.getId()))));
					parameters.add(new Pair<>(HellBiome.PARAMETER_POINT_UNDERGROUND,
							biomeRegistry.getOrCreateHolderOrThrow(ResourceKey.create(Registry.BIOME_REGISTRY, HELL.getId()))));
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					...
					if (currentRuleSource instanceof SurfaceRules.SequenceRuleSource sequenceRuleSource) {
						...
						surfaceRules.add(1,
								anySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, HELL.getId()), Blocks.CRIMSON_STEM.defaultBlockState(),
										Blocks.IRON_BLOCK.defaultBlockState(), Blocks.DIAMOND_BLOCK.defaultBlockState()));
						surfaceRules.add(1,
								preliminarySurfaceRule(ResourceKey.create(Registry.BIOME_REGISTRY, HELL.getId()),
										Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.IRON_BLOCK.defaultBlockState(),
